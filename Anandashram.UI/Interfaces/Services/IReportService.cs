...
public interface IReportService
{
    ...
    Task<ReportResult<byte[]>> DevoteeCheckOutReportList(DateTime dateValue, string typeofreport);
    ...
    Task<MemoryStream> ExportDevoteeCheckOutToExcel(DateTime dateValue, string Subject);
